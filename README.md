...
基于 [长桥 OpenAPI](https://open.longbridge.com) 构建的_实验性_终端股票交易应用。

这是一个基于 Rust 的 TUI（终端用户界面）应用，用于监控市场数据和管理股票投资组合。旨在展示长桥 OpenAPI SDK 的功能。
...
这将在您的终端中安装 `changqiao` 命令。

## 配置

在运行应用之前，您需要配置 长桥 OpenAPI 凭证：
